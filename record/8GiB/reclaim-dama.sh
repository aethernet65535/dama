...
rm -rf ./report/rec-dama-2026-05-24-0002/
mkdir -p ./report/rec-dama-2026-05-24-0002/

cat /proc/vmstat | rg "refault" >> ./report/rec-dama-2026-05-24-0002/refault.txt
cat /proc/vmstat | rg "pgsteal" >> ./report/rec-dama-2026-05-24-0002/pgsteal.txt
cat /sys/module/damon_reclaim/parameters/bytes_reclaimed_regions >> ./report/rec-dama-2026-05-24-0002/damon_passed.txt
sar -r 5 $(((2*60*60)/5)) >> ./report/rec-dama-2026-05-24-0002/memu.txt &
sar -q CPU 5 $(((2*60*60)/5)) >> ./report/rec-dama-2026-05-24-0002/cpu.txt &
sar -q IO 5 $(((2*60*60)/5)) >> ./report/rec-dama-2026-05-24-0002/io.txt &
sar -q MEM 5 $(((2*60*60)/5)) >> ./report/rec-dama-2026-05-24-0002/memo.txt &
sar -B 5 $(((2*60*60)/5)) >> ./report/rec-dama-2026-05-24-0002/fault.txt &

echo $((10 * 1000000)) > /sys/module/damon_reclaim/parameters/min_age
/home/user/workspace/github/dama/dama >> ./report/rec-dama-2026-05-24-0002/dama.txt &
