...
rm -rf ./report/lru-dama-2026-05-24-0001/
mkdir -p ./report/lru-dama-2026-05-24-0001/

cat /proc/vmstat | rg "refault" >> ./report/lru-dama-2026-05-24-0001/refault.txt
cat /proc/vmstat | rg "pgsteal" >> ./report/lru-dama-2026-05-24-0001/pgsteal.txt
cat /sys/module/damon_lru_sort/parameters/bytes_lru_sorted_cold_regions >> ./report/lru-dama-2026-05-24-0001/damon_passed.txt
sar -r 5 $(((2*60*60)/5)) >> ./report/lru-dama-2026-05-24-0001/memu.txt &
sar -q CPU 5 $(((2*60*60)/5)) >> ./report/lru-dama-2026-05-24-0001/cpu.txt &
sar -q IO 5 $(((2*60*60)/5)) >> ./report/lru-dama-2026-05-24-0001/io.txt &
sar -q MEM 5 $(((2*60*60)/5)) >> ./report/lru-dama-2026-05-24-0001/memo.txt &
sar -B 5 $(((2*60*60)/5)) >> ./report/lru-dama-2026-05-24-0001/fault.txt &

echo $((300 * 1000000)) > /sys/module/damon_lru_sort/parameters/cold_min_age
/home/user/workspace/github/dama/dama >> ./report/lru-dama-2026-05-24-0001/dama.txt &
