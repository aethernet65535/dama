...
rm -rf ./report/rec-default-2026-05-24-0002/
mkdir -p ./report/rec-default-2026-05-24-0002/

cat /proc/vmstat | rg "refault" >> ./report/rec-default-2026-05-24-0002/refault.txt
cat /proc/vmstat | rg "pgsteal" >> ./report/rec-default-2026-05-24-0002/pgsteal.txt
cat /sys/module/damon_reclaim/parameters/bytes_reclaimed_regions >> ./report/rec-default-2026-05-24-0002/damon_passed.txt
sar -r 5 $(((2*60*60)/5)) >> ./report/rec-default-2026-05-24-0002/memu.txt &
sar -q CPU 5 $(((2*60*60)/5)) >> ./report/rec-default-2026-05-24-0002/cpu.txt &
sar -q IO 5 $(((2*60*60)/5)) >> ./report/rec-default-2026-05-24-0002/io.txt &
sar -q MEM 5 $(((2*60*60)/5)) >> ./report/rec-default-2026-05-24-0002/memo.txt &
sar -B 5 $(((2*60*60)/5)) >> ./report/rec-default-2026-05-24-0002/fault.txt &
